...
export default {
    ...
    emailIdPasswordError:'Email id or password not correct.',
    accountNotConfirmed:
      'Your account is not confirmed.Please confirm verification link sent your registered email.',
    accountNotActive:
      'Your account is not Activate by Admin.Please contact Admin.',
    ...
    otpExpired:"OTP Exipred or Incorrect.",
    forgotPassword: 'An OTP is sent to the registered email Id. Please use that to otp to reset password.',
